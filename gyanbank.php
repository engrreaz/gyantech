...
if ($userlevel == 'Super Administrator' || $userlevel == 'Administrator') {
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-book"></i> Gyans</h1>
                <p>All Gyans (Knowledge Base) including Pending, Rejected even suspended.</p>
            </div>
            <?php $pagelink = 'Gyans';
                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="table-responsive" id="quetable">
                            ...
                            $cat = '';
                            $subcat = '';
                            include 'backend/gyantablemain.php'; ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function goto(id, tail) {
            window.location.href = 'index.php?id=' + id + "&tail=" + tail;
        }
    </script>
